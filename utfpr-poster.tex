...
\begin{flushleft}
\includegraphics[width = \columnwidth]{./Logos/logo_ICINCO_2}%% Logomarca superior-esquerdo
\vspace*{0.5\baselineskip}
\includegraphics[width = \columnwidth]{./Logos/logo_INSTICC_2}%% Logomarca inferior-esquerdo
\vspace*{0.5\baselineskip}
\includegraphics[width = \columnwidth]{./Logos/inesc}%% Logomarca inferior-esquerdo
\end{flushleft}
\end{column}
%
...
\vspace*{0.5\baselineskip}
\includegraphics[width = \columnwidth]{./Logos/logo_IPB_2}%% Logomarca inferior-direito
\vspace*{0.5\baselineskip}
\includegraphics[width = \columnwidth]{./Logos/cedri}%% Logomarca
%\vspace*{0.5\baselineskip}
...
% , as can be seen in figure \ref{fig:fluxograma}.

% \vspace{-0.15cm}
% \begin{figure}[!htb]
%     \centering
%     \includegraphics[scale=0.17]{Figuras/Fluxograma.png}
